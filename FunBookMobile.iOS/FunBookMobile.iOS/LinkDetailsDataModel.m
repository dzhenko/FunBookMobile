...
@implementation LinkDetailsDataModel
...
+(LinkDetailsDataModel*) fromJsonDictionary:(NSDictionary *)jsonDictionary{
    return [[LinkDetailsDataModel alloc]
